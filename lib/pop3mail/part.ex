defmodule Pop3mail.Part do
   ...
   @type t :: %Pop3mail.Part{index: integer, media_type: String.t, charset: String.t, path: String.t,
                             filename: binary, filename_charset: String.t, boundary: String.t, content: binary,
                             content_id: String.t, content_location: String.t, inline: boolean | nil}
   defstruct index: 0, media_type: "text/plain", charset: "us-ascii", path: "", filename: "", filename_charset: "us-ascii",
             boundary: "", content: "", content_id: "", content_location: "", inline: nil
